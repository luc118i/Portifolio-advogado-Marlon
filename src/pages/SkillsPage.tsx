        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
          {skills.map((skill, index) => {
            ...
            return (
              <div 
                key={index}
                className="bg-white/5 backdrop-blur-sm p-6 md:p-8 rounded-sm border border-[#888888]/30 hover:border-[#888888] transition-all hover:bg-white/10 group"
              >
                <div className="flex flex-col items-center text-center gap-4">
                  <div className="w-14 h-14 md:w-16 md:h-16 rounded-full bg-[#888888]/20 flex items-center justify-center group-hover:bg-[#888888] transition-colors">
                    <Icon className="w-7 h-7 md:w-8 md:h-8 text-[#888888] group-hover:text-[#1C1C1C]" />
                  </div>
                  <h3 
                    className="text-white"
                    style={{
